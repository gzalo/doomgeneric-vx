...
void D_DoomLoop (void)
{
    ...
    {
        vxprintf(" WARNING: You are playing using one of the Doom Classic\n"
...
static void SetMissionForPackName(char *pack_name)
{
    ...
    vxprintf("Valid mission packs are:\n");
...
static void InitGameVersion(void)
{
    ...
    if (p)
    {
        ...
        {
            vxprintf("Supported game versions:\n");
...
void PrintGameVersion(void)
{
    ...
    for (i=0; gameversions[i].description != NULL; ++i)
    {
        ...
        {
            vxprintf("Emulating the behavior of the "
                   "'%s' executable.\n", gameversions[i].description);
            break;
        }
    }
...
void D_DoomMain (void)
{
    ...
    {
        vxprintf("Dedicated server mode.\n");
        NET_DedicatedServer();
    ...
    {
        vxprintf("BFG Edition: Using workarounds as needed.\n");
        bfgedition = true;
...
//    W_PrintDirectory();
    ...
    if (M_ParmExists("-dehlump"))
    {
        ...
        vxprintf("  loaded %i DEHACKED lumps from PWAD files.\n", loaded);
    }
#endif
    ...
    {
        I_PrintDivider();
        vxprintf(" WARNING: The loaded WAD file contains modified sprites or\n"
    ...
    {
        vxprintf(" WARNING: You are playing using one of the Freedoom IWAD\n"
...
#ifdef FEATURE_MULTIPLAYER
    vxprintf ("NET_Init: Init network subsystem.\n");
    NET_Init ();
#endif
