...
void M_LoadDefaults (void)
{
    ...
    if (i)
    {
        ...
        vxprintf("        extra configuration file: %s\n", 
...
void M_SetConfigDir(char *dir)
{
    ...
    {
        vxprintf("Using %s for configuration and saves\n", configdir);
    }
...
char *M_GetSaveGameDir(char *iwadname)
{
    ...
    else
    {
        ...
        vxprintf ("Using %s for savegames\n", savegamedir);
#endif
    }
